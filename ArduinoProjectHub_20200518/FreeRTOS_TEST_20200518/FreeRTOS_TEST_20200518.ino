...
void setup() 
{
  ...
  xTaskCreate(Task1_func, "Task1", 128, NULL, 1, NULL); //创建任务1
  xTaskCreate(Task2_func, "Task2", 128, NULL, 2, NULL); //创建任务2
  //xTaskCreate(Task3_func, "Task3", 128, NULL, 3, NULL); //创建任务3
  //xTaskCreate(Task4_func, "Task4", 128, NULL, 4, NULL); //创建任务4
